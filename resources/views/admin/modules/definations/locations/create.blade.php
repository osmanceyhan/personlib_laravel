...
@section('content')
    @component(getAdminView('common-components.breadcrumb'))
        ...
        @slot('title') Yeni Lokasyon @endslot
    @endcomponent
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form  action="{{route(getRouteWeb('locations.store'))}}"  method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                         <div class="row d-flex">
                             <div class="mb-3 row">
                                 <label for="input_title" class="col-md-2 col-form-label">Lokasyon İsmi</label>
                                 <div class="col-md-10">
