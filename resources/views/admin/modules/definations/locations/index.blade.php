...
@section('content')
    @component(getAdminView('common-components.breadcrumb'))
        ...
        @slot('title') Lokasyonlar Listesi @endslot
    @endcomponent
    <!--  Modal  -->
    @include(getAdminModule('definations.locations.modal'))
    <div class="row">
        <div class="col-md-4">
            <div>
                <a href="{{route(getRouteWeb('locations.create'))}}" class="btn btn-success waves-effect waves-light mb-3"   ><i class="mdi mdi-plus me-1"></i> Yeni Sayfa</a>
            </div>
        </div>
        <div class="col-md-8">
            <div class="float-end">
                ...
                <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                    ...
                    @foreach($results as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{route(getRouteWeb('locations.edit'),$item->id)}}" class="text-dark fw-bold">{{$item->id}}</a>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="{{route(getRouteWeb('locations.avabilities'),$item->id)}}" class="btn btn-secondary btn-sm"><i class="fas fa-location-arrow"></i> Lokasyon Müsaitliklerini Düzenle</a>
                                <a href="{{route(getRouteWeb('locations.edit'),$item->id)}}"   class="btn px-3 text-primary bg-none"><i class="uil uil-pen font-size-18"></i></a>
