...
@section('content')
    @component(getAdminView('common-components.breadcrumb'))
        @slot('pagetitle')Kategoriler @endslot
        @slot('title') Yeni Kategori @endslot
    @endcomponent
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form  action="{{route(getRouteWeb('geoCodes.store'))}}"  method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
