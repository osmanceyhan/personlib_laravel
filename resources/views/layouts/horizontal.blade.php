        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{url('index')}}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/logo-dark.svg') }}" alt="" height="20">
                    </span>
                </a>
                ...
                <a href="{{url('index')}}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/logo-wight.svg') }}" alt="" height="20">
                    </span>
                </a>
            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <a href="ui-typography" class="dropdown-item">@lang('translation.Typography')</a>
                                             <a href="ui-toasts" class="dropdown-item">Toasts</a>
