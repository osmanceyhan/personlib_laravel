<div class="modal fade leave_modal" id="overTimeModal" tabindex="-1" role="dialog" aria-labelledby="overTimeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('payment_requests.store')); ?>" method="post" id="overTimeRequestForm">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/yesevi/proje/resources/views/components/overTimeModal.blade.php ENDPATH**/ ?>