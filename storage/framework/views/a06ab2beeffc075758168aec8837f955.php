                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="center" class="center-text">
                                                            <img src="<?php echo e($message->embed(public_path('assets/images/personify_white.png'))); ?>" alt="Personify" style="height: 40px; border: 0px; display: inline !important; margin: auto; text-align: center;" width="72">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        Hoşgeldin <?php echo e($data['user']->fullName()); ?>,
                                    </div>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div  >
                                        15 gün süre ile kullanabileceğin demo hesabın başarıyla oluşturuldu.
                                    </div>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                <a href="#" target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>Hemen Giriş Yap</span></a>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                ...
                <tr  >
                    <td align="center"  bgcolor="#FFFFFF">
                        <img src="<?php echo e($message->embed(public_path('assets/images/mail_arrow.png'))); ?>" alt="Arrow" style="width: 50px; border: 0px; display: inline !important;">
                    </td>
                </tr>
            </table>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row" width="100%" style="width:100%;max-width:100%;">
                                                    <tr  >
                                                        <td class="center-text container-padding"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">

                                                            <div  >
                                                                Aşağıdaki bilgileri kullanarak demo hesabına giriş yapabilirsin.<br />
                                                                E-Posta : <?php echo e($data['user']->email); ?><br />
                                                                Parolan : <?php echo e($data['password']); ?>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="tel:+905434998586"    style="color:#6e6e6e;"><span>+(90) 543 499 8586</span></a>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="mailto:info@personify.com"    style="color:#6e6e6e;"><span>info@personify.com</span></a> - <a href="https://wwww.personify.com"    style="color:#6e6e6e;"><span>www.personify.com</span></a>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/yesevi/proje/resources/views/mail/register.blade.php ENDPATH**/ ?>