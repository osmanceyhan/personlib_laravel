<div class="modal fade leave_modal" id="expenditureModal" tabindex="-1" role="dialog" aria-labelledby="adavancePaymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('payment_requests.store')); ?>" method="post" id="expenditureRequestForm">
                <?php echo csrf_field(); ?>
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/yesevi/proje/resources/views/components/expenditureModal.blade.php ENDPATH**/ ?>