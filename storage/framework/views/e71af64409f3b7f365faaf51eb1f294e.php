        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form  action="<?php echo e(route('leave_types.store')); ?>"  method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                 ...
                                 <div class="col-md-10">
                                     ...
                                     <select class="select2 form-control" name="type">
                                         <?php $__currentLoopData = \App\Enumerations\LeaveTypeEnum::allStatus(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $leaveType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <option value="<?php echo e($key); ?>"><?php echo e($leaveType); ?></option>
                                     ...
                                     <div class="select2-full">
                                         <select class="select2 form-control" name="price_type">
                                             <?php $__currentLoopData = \App\Enumerations\PriceTypeEnum::allStatus(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $priceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                 <option value="<?php echo e($key); ?>"><?php echo e($priceType); ?></option>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         </select>
                                     </div>
                                 </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/yesevi/proje/resources/views/definations/leave_types/create.blade.php ENDPATH**/ ?>