...
class AdminsController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view(getAdminModule('admins.index'),compact('results','user_type'));
    ...
    public function create()
    {
        //
        try {
            return view(getAdminModule('admins.create'));
        } catch (QueryException $e) {
            return redirect()->route(getRouteWeb('admins.index'))->with('alert',['status' => 'danger','title' => 'İşlem Başarısız','message' => 'Veritabanı Hatası!']);
        } catch (\Exception $e) {
            return redirect()->route(getRouteWeb('admins.index'))->with('alert',['status' => 'danger','title' => 'İşlem Başarısız','message' => 'Veri Listelenemedi!']);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route(getRouteWeb('admins.index'))->with('alert',['status' => 'success','title' => 'İşlem Başarılı','message' => 'Veri başarıyla eklendi.']);
        } catch (QueryException $e) {
            return redirect()->route(getRouteWeb('admins.index'))->with('alert',['status' => 'danger','title' => 'İşlem Başarısız','message' => 'Veritabanı Hatası!']);
        } catch (\Exception $e) {
            return redirect()->route(getRouteWeb('admins.index'))->with('alert',['status' => 'danger','title' => 'İşlem Başarısız','message' => 'Veri Eklenemedi!']);
        }
    }
    ...
    public function edit(string $id)
    {
        try {
            ...
            return view(getAdminModule('admins.edit'),$compact);
        } catch (QueryException $e) {
